//! Integration tests for failure rate backoff functionality
//!
//! These tests verify that automatic backoff with jitter is triggered when failure rates
...
async fn test_failure_rate_backoff_automatic_recovery() {
    ...
    // The backoff will automatically expire after 30-45 seconds
}
...
async fn test_failure_rate_mixed_errors() {
    ...
    // Should trigger backoff (2/100 = 2% > 1%)
